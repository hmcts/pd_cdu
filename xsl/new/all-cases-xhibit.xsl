...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <!-- Setting Meta Data and Attaching Javascript -->
            ...
            <body>
                ...
                <!-- Div Containing Reporting Restrictions -->
                ...
                <div id="pageTitle" class="title">
					...
					<div class="lastUpdated bigtext-exempt">
						<span id="lastUpdated">
							<xsl:if test="COURT/PAGE/LANGUAGE = 'English'">
								Last Updated: 
							</xsl:if>
                    ...
                    <table id="resultTable" class="results" border="0" cellpadding="3" cellspacing="0">
                        <thead id="tableHeader">
                            ...
                            <xsl:if test="COURT/PAGE/LANGUAGE = 'Welsh'">
								<tr class="column-headers">
									<td width="10%">Llys</td>
									<td width="30%">Enw / Rhif yr Achos</td>
									<td width="10%">Ddim Cyn</td>
									<td width="50%">Statws</td>
								</tr>
                            </xsl:if>
                        </thead>
                                        ...
                                        <div style="word-wrap:break-word;overflow:auto">
											...
											<xsl:value-of select="$COURTROOM" /><!-- Generated Content -->
												<xsl:if test="MOVEDROOM">
													<div class="moved-highlight">
														<xsl:value-of select="MOVEDROOM"/>
													</div>
												</xsl:if>
                                        </div>
                                    </td>
                                    ...
                                    <xsl:if test="LIVESTATUS">
                                        <td>
                                            <div>
												...
												<span>
													<xsl:value-of select="LIVESTATUS"/>
												</span>
                                            </div>
                                        </td>
                                    </xsl:if>
